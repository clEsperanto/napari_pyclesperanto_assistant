...
setuptools.setup(
    ...
    install_requires=["numpy", "pyopencl", "toolz", "scikit-image", "napari==0.4.2", "napari_plugin_engine", "pyclesperanto_prototype==0.6.0", "magicgui==0.2.1", "numpy!=1.19.4", "pyperclip"],
    python_requires='>=3.6',
    classifiers=[
