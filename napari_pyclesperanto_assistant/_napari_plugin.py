...
from ._convert_to_numpy import convert_to_numpy, convert_to_2d_timelapse, make_labels_editable, reset_brightness_contrast
...
def napari_experimental_provide_function():
    return [statistics_of_labeled_pixels, make_labels_editable, reset_brightness_contrast, convert_to_numpy, convert_to_2d_timelapse]
