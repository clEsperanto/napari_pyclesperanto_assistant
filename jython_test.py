...
cle.top_hat_box(image1, image2, 5.0, 5.0, 0.0)
# show result
cle.imshow(image2, 'Result of top_hat_box', False, 0, 223.37708)
...
cle.touching_neighbor_count_map(image4, image5)
# show result
cle.imshow(image5, 'Result of touching_neighbor_count_map', False, 0, 8.0)

# Layer Result of detect_label_edges
image6 = cle.create_like(image4)
cle.detect_label_edges(image4, image6)
# show result
cle.imshow(image6, 'Result of detect_label_edges', False, 0, 1)
