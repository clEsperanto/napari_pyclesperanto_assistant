...
from .._operations._operations import filter, binarize, combine, label, label_processing, map, mesh, measure
...
class Gui(QWidget):
    ...
    def _export_code(self):
        print(_PythonScriptGenerator(self.viewer.layers).generate())
